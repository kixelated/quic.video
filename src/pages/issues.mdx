...
| name                      | description                                                                                                                                                                      |
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| WebTransport - Safari     | No Safari support yet. Webkit has expressed [public support](https://github.com/WebKit/standards-positions/issues/18#issuecomment-1495890122) so it will likely show up one day. |
| WebCodecs - Firefox       | No Firefox support yet. Firefox has an implementation on nightly [behind a flag](https://groups.google.com/a/mozilla.org/g/dev-platform/c/3g0fnn6682A/m/Nb1qVaA4AAAJ).           |
| General - Codec Support   | WebCodecs supports a lot of codecs, but they need to be configured and correctly packaged into MP4.                                                                              |
| General - Optional Tracks | You can't publish/subscribe to optional tracks, which is required for any form of ABR.                                                                                           |
| General - Dynamic Tracks  | You can't add/remove tracks once a broadcast has started, such as to change input device or screen share.                                                                        |
| UI - Make it Pretty       | Obviously, I'm not an artist.                                                                                                                                                    |
