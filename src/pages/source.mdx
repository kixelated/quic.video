...
- [kixelated/quic.video](https://github.com/kixelated/quic.video): This website. Includes terraform to run on GCP.
...
| package | description |
| ------- | ----------- |
| [@kixelated/moq](https://www.npmjs.com/package/@kixelated/moq) | A moq-lite client that mirrors the Rust API.  |
...
**Note**: These utilize browser-specific APIs do not support for Node.
