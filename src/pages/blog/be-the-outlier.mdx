...
author: kixelated
description: Embrace the median and be the outlier. Not MoQ related, but advice for software engineers instead.
...
I've been [working on a startup](/application-first) for the last month.
